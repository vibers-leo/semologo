...
export const SUBMITTED_BRANDS: Brand[] = [
  ...
  ].map(([id,name]) => ({ id, name_ko:name, name_en:name, category:"공공·기관", logo_png:`/submissions/official-ci/${name}.png`, has_png:true, origin:"KR", kr_kind:"공식 CI 검수 후보", asset_origin:"공식 CI 수집 후보" } as Brand)),
  {
  id: "spursmtech", name_ko: "스펄스엠텍", name_en: "Spurs Mtech",
