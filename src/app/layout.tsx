...
export const metadata: Metadata = {
  title: "세모로고 — 세상 모든 로고",
  description: "브랜드 로고를 SVG·PNG로 무료 다운로드. 현대·삼성·LG·SK·스타벅스 등 5,765개 브랜드. 세상 모든 로고, 세모로고.",
  ...
  openGraph: {
    title: "세모로고 — 세상 모든 로고",
    description: "현대·삼성·LG·SK 등 5,765개 브랜드 로고를 SVG·PNG로 무료 다운로드",
    siteName: "세모로고",
  ...
  twitter: {
    ...
    title: "세모로고 — 세상 모든 로고",
    description: "5,765개 브랜드 로고 SVG·PNG 무료 다운로드",
